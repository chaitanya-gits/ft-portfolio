...
function readState(elements) {
    return {
        ...
        occasion: elements.occasionSelect.value,
        mood: elements.moodSelect.value,
        rainSafeRequired: elements.rainToggle.checked,
    };
}
function calculateMatchScore(state, outfit) {
    let score = 0;
...
function renderRecommendation(elements, topOutfit, confidence) {
...
function renderAlternatives(elements, rankedOutfits) {
...
function updatePlanner(elements) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const update = () => updatePlanner(elements);
